...
async def start(bot, update):
    TEXT = "Hi {} \n\n**I Am XFlickz Lyrics Search Bot. Send Me A Song Name, I Will Give You The Lyrics. ** \n\nFor Know More /help"
    BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton("Channel 🔰", url = "https://telegram.me/xFlickbot" ),InlineKeyboardButton("Support Group ⭕️", url = ""https://telegram.me/SharingUserbot)],[InlineKeyboardButton("Repo 🗂️", url = "https://github.com/GENZxM/Lyrics-Search-Bot"),InlineKeyboardButton("Deploy 🗃️", url = "https://heroku.com/deploy?template=https://github.com/GENZxM/Lyrics-Search-Bot")],[InlineKeyboardButton("Developer 💡", url = "https://github.com/XFlickz/")]])
...
def lyrics(song):
        ...
        text += f'`{fin["lyrics"]}`'
        text += '\n\n\n**Made With ❤️ By @JakaSombong6789**'
        return text
